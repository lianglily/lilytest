...
namespace appfront\local\local_modules\Cms\block\article;
...
class Index
{
    ...
    public function getLastData()
    {
        ...
        if($this->_title=="Delivery Time"){
	        echo Yii::$service->store->getStoreAttrVal($this->_artile['content'], 'content');
	        die();
        }else{
