...
namespace appfront\local\local_modules\Payment\block\paypal\standard;
...
class Placeorder
{
    ...
    public function getLastData()
    {
        ...
        if ($doCheckoutReturn) {
            ...
            $orderPayment = Yii::$service->payment->paypal2->updateOrderPayment($doCheckoutReturn,$token);
    ...
    public function doCheckoutPayment($token)
    {
        ...
        $doCheckoutReturn = Yii::$service->payment->paypal2->getCheckoutPaymentNvpStr($token);
