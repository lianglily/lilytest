...
class Index
{
    ...
    public function getLastData()
    {
        ...
        $qtys  = Yii::$service->product->stock->getQtyByProductIds(array($this->_product[$productPrimaryKey]));
        ...
        return [
            ...
            'unit'                		=> unserialize($this->_product['unit']),
            'media_size' => [
    ...
    protected function getProductPriceInfo()
    {
        ...
        return Yii::$service->product->price->getCurrentCurrencyProductPriceInfo($price, $special_price, $special_from, $special_to,$this->_product['id']);
    }
