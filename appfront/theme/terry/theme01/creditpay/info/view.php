							...
							<div class="box">
                                <div class="box-content">
                                    <address>
                                		...
                                		<label class="label_info"><?= Yii::$service->page->translate->__('Order Total');?>：</label><label style="text-align: left;" class="label_info"><?= $order_currency_code ?><?=  Format::price($grand_total); ?></label><br>
                                		<label class="label_info"><?= Yii::$service->page->translate->__('Payment Method');?>：</label><label style="text-align: left;" class="label_info"><?=  Yii::$service->page->translate->__($paymentConfig['label']) ?></label><br>
                                		...
                                		<label class="label_info"><?= Yii::$service->page->translate->__('Order Status');?>：</label><label style="text-align: left;" class="label_info"><?= Yii::$service->page->translate->__(Yii::$service->order->getSelectProcessStatusArr()[$order_process_status]) ;?></label><br>
                                    </address>
                                </div>
                            </div>				
                        </div>
							...
							<div class="box">
                                ...
                                <div class="box-content">
                                    ...
                                    <div class="layui-upload">
                                      <div class="layui-upload-list" style="display:inline-table">
                                      	<?php if($credentials_payment){?>
									    <img class="layui-upload-img" id="demo1" style="width:100px;height:100px" src="<?=  Yii::$service->url->getUrl('checkout/credentialsupload/imageshow',['msg' => $credentials_payment]);?>">
									    <?php }else{ ?>
