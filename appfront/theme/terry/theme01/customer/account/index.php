										...
										<form class="layui-form"  method="post" id="form-validate" autocomplete="off" action="<?=  Yii::$service->url->getUrl('customer/editaccount') ?>">
										  ...
										  <div class="layui-form-item">
										    <div class="layui-inline">
										      <label for="email" class=" required layui-form-label"><?= Yii::$service->page->translate->__('Company CN');?></label>
										    ...
										    <div class="layui-form-item">
										    <div class="layui-inline">
										      <label class="layui-form-label required"><?= Yii::$service->page->translate->__('Company EN');?></label>
										      <div class="layui-input-inline">
										  ...
										  <div class="layui-form-item">
										    <div class="layui-inline">
										      <label for="email" class=" required layui-form-label"><?= Yii::$service->page->translate->__('Email Address');?></label>
										      <div class="layui-input-inline">
										  ...
										  <div class="layui-form-item">
										    <div class="layui-inline">
										      <label for="email" class=" required layui-form-label"><?= Yii::$service->page->translate->__('First Name');?></label>
										      <div class="layui-input-inline">
										    ...
										    <div class="layui-inline">
										      <label class="layui-form-label required"><?= Yii::$service->page->translate->__('Last Name');?></label>
										      <div class="layui-input-inline">
										  ...
										  <div class="layui-form-item" pane="">
										    <div class="layui-inline">
										      ...
										      <input lay-skin="primary" name="editForm[change_password]" id="change_password" value="1" lay-filter="setPasswordForm"  title="Change Password" class="checkbox" type="checkbox" >
										    </div>
										  </div>
										  <div class="" id="fieldset_pass" class="display_none">
										  	 <div class="layui-form-item">
										  	 	
											    <div class="layui-inline">
											      <label for="current_password" class="required layui-form-label"><?= Yii::$service->page->translate->__('Current Password');?></label>
											      <div class="layui-input-inline">
											  ...
											  <div class="layui-form-item">
											    <div class="layui-inline">
											      <label for="password" class="required layui-form-label"><?= Yii::$service->page->translate->__('New Password');?></label>
											      <div class="layui-input-inline">
											  ...
											  <div class="layui-form-item">
											    <div class="layui-inline">
											      <label for="confirmation" class="required layui-form-label"><?= Yii::$service->page->translate->__('Confirm New Password');?></label>
											      <div class="layui-input-inline">
