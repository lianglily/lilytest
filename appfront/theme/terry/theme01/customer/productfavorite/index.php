	...
	<div class="col-main account_center">
		<div class="std">
			<div class="margin_4">
				...
				<div class="width_100 height_500" >
					<div class="width_100">
						<?php if(is_array($coll) && !empty($coll)):  ?>
						<ul id="review_description" class="padding_0">
							<?php  foreach($coll as $one):  ?>
							<?php  $main_img = $one['image']['main']['image'];  ?>
							<li class="width_100 height_160" >
								<div class="review_description_left">
									<a target="_blank" href="<?= Yii::$service->url->getUrl($one['url_key'])  ?>">
									<p class="text_center"><img alt="<?= $one['url_key'] ?>" src="<?= Yii::$service->product->image->getResize($main_img,[120,120],false) ?>"></p>
									</a>
								</div>
								<div class="review_description_right width_600" >
									...
									<div class="review_description_centen">
										<div class="category_product display_inline-table table-caption_left" >
                                            <?php
                                                $diConfig = [
                                                    'price' 		=> $one['price'],
										...
										<div class="favorite-Operation display_inline-table float_right margin_top_0" >
