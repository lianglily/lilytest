...
<div class="main container two-columns-left">
						...
						<li class="fields">
							<div class="customer-name">
								<div class="field name-firstname">
									...
									<div class="height_10" id="contacts_name_span"></div>
								</div>
								<div class="field name-lastname">
									...
									<div class="height_10" id="contacts_email_span"></div>
						...
						<li>
							...
							<div class="input-box login_box">
								<input class="verification_code_input" maxlength="4" name="sercrity_code" value="" type="text">
									<img alt="click refresh" class="login-captcha-img"  title="click refresh" src="<?= Yii::$service->url->getUrl('site/helper/captcha'); ?>?<?php echo md5(time() . mt_rand(1,10000));?>" align="absbottom" onclick="this.src='<?= Yii::$service->url->getUrl('site/helper/captcha'); ?>?'+Math.random();"></img>
	...
	<div class="col-left ">
		<div class="block contact-us-address-block">
			<div class="block-title">
				<h2><?= Yii::$service->page->translate->__('Contacts'); ?></h2>
			</div>
			<div class="block-content">
				<strong><?= Yii::$service->page->translate->__('Email Address'); ?>:</strong> 
					<a style="word-wrap: break-word;" href="mailto:<?= $contactsEmail ?>"><?= $contactsEmail ?></a>
				<br>
			</div>
		</div>
	</div>
