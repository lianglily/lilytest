 ...
 */
?>
<?php $url= Yii::$service->url->getUrl('catalog/productsimple/index')."?id={$_id}";?>
<div class="main container one-column">
<?= Yii::$service->page->widget->render('base/flashmessage'); ?>
	<div class="col-main">
		<div class="std">
			<div class="review_lists">
				<div class="review_list_product width_100" >
					<div class="width_170 float_left">
						<a href="<?= $url ?>">
							<img alt="<?= $name ?>" src="<?= Yii::$service->product->image->getResize($main_img,[150,150],false) ?>">
						</a>
					</div>
					
					<div class="width_600 float_left" >
						<div style="">
						...
						<div class="margin_20">
							<div class="rbc_cold">
								<span>
									...
									<span class="review_star review_star_<?= round($reviw_rate_star_average) ?>" class="font-weight_bold" itemprop="average"></span>  
                    ...
                    <div class="box pro_commit">
                        ...
                        <div class="lbBox writeRiviewTitle">
                            ...
                            <div class="lineBlock writeRiviewBtn">
                                <button type="submit" title="Save" class="button btn btn-primary addreview" onclick="javascrtpt:window.location.href='<?= Yii::$service->url->getUrl('catalog/productsimple/reviewadd',['spu'=>$spu,'_id'=>$_id]); ?>'"><span><span><?= Yii::$service->page->translate->__('Write a Customer Review'); ?></span></span></button>
                            </div>
                        </div>
