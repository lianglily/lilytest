 ...
 */
?>
<?php $options_attr_arr = $parentThis['options']; $mode= isset($parentThis['mode'])?$parentThis['mode']:true;?>
...
<?php		        
					...
					if($mode){
						...
						if($active=='active'){
							$url   =Yii::$service->url->getUrl('catalog/productsimple/index')."?id={$info['id']}";
						}
					}
?>
