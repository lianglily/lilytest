	...
	<div class="col-main">
		<div class="std">
			<div class="product-Reviews_top">
				<div class="width_90 float_left" >
					<a href="<?= $url  ?>">
						<img alt="<?= $product_name ?>" src="<?= Yii::$service->product->image->getResize($main_img,[80,80],false) ?>">
					</a>
				</div>
				...
				<form method="post" action="">
					...
					<div class="h-30">
						...
						<div class="lh30_f">
							...
							<span class="review_span_error" id="review_price_span" class="span_inline"></span>
						</div>
					</div>
					...
					<div id="review_create">
						<ul id="reviews_form_list">
							...
							<li id="review_textarea" class="width_722">
							...
							<?php if($add_captcha):  ?>
							<li class="width_700" style="width:700px">
								...
								<div class="input-box login-captcha">
									...
									<img alt="点击刷新" class="login-captcha-img"  title="点击刷新" src="<?= Yii::$service->url->getUrl('site/helper/captcha'); ?>?<?php echo md5(time() . mt_rand(1,10000));?>" align="absbottom" onclick="this.src='<?= Yii::$service->url->getUrl('site/helper/captcha'); ?>?'+Math.random();"></img>
