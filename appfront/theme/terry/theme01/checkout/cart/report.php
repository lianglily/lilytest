							...
							<tbody>
								...
								<tr class="first last odd">
									...
									<td class="a-right last">
										<a class="width_right" href="javascript:void(0)"  rel="<?= $product_one['item_id']; ?>" title="Remove item" class="btn-remove btn-remove2"><?= Yii::$service->page->translate->__('Remove item');?></a>
									</td>
								</tr>
								<?php  endforeach;  ?>
								...
								<div class="discount">
									...
									<div class="discount-form">
										...
										<div class="input-box">
											...
											<input  class="input-text color_777" id="coupon_code" name="coupon_code" value="<?= $cart_info['coupon_code']; ?>">
										</div>
