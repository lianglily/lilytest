...
return [
    'catalog' => [
        ...
        //],
        'controllerMap' => [
            'productsimple' => '\appfront\local\local_modules\Catalog\controllers\ProductsimpleController', 
			'pcservices' => '\appfront\local\local_modules\Catalog\controllers\PcservicesController',   
			'category' => 'fecusergroup\app\appfront\modules\Catalog\controllers\CategoryController',
            'product'  => 'fecusergroup\app\appfront\modules\Catalog\controllers\ProductController',
        ],
        'params'=> [
            //##############################
            //# 		category部分设置	 ##
