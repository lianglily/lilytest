...
// set namespace alisa
Yii::setAlias('@fecusergroup', dirname(dirname(__DIR__)).'/addons/fecmall/fecusergroup/');
Yii::setAlias('@certmanage', dirname(dirname(__DIR__)).'/addons/fecmall/certmanage/');
// set namespace alisa
Yii::setAlias('@fecelastic', dirname(dirname(__DIR__)).'/addons/fecmall/fecelastic/');
