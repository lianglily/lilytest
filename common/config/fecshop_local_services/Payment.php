...
return [
    'payment' => [
		'class' => 'common\local\local_services\Payment',
        /**
        ...
        //'offLinePaymentMethod' => ['payment_banktransfer','payment_FPS'],
        'paymentConfig' => [        // 支付方式配置
            'standard' => [            // 标准支付类型：在购物车页面进入下单页面，填写支付信息，然后跳转到第三方支付网站的支付类型。
				...
				'cash_cheque' => [    // 货到付款类型。
                    'label'                => 'Cash Cheque',
                    //'image' => ['images/mastercard.png','common'] ,# 支付页面显示的图片。
                    'supplement'               => '以劃線支票付款，抬頭請寫”Burotech Limited“ 或 ”普德有限公司"，期票恕不接受。<br>地址: 九龍觀塘海濱道177號海裕工業中心3樓', // 补充信息
                    'style'                    => '<style></style>',  // 补充css，您可以在这里填写一些css
                    'start_url'                => '@homeUrl/payment/checkmoney/start',    // 点击按钮后，跳转的url，在这个url里面写支付跳转前的提交信息。
                    'success_redirect_url'     => '@homeUrl/payment/success',            // 在支付平台支付成功后，返回的页面
					'sap_id'				   => 'HOD'
                ],
                'payment_banktransfer' => [    // 货到付款类型。
                    'label'                => 'Bank Entry/FPS',
                    //'image' => ['images/mastercard.png','common'] ,# 支付页面显示的图片。
                    'supplement'               => '戶口名稱: BUROTECH LIMITED / 普德有限公司<br>1) 匯豐銀行: 555-079839-001<br>2) 轉數快 (FPS) 號碼: 6866909<br>請根據此單金額入賬並上傳銀行收據或相關截圖到此單', // 补充信息
                    'style'                    => '<style></style>',  // 补充css，您可以在这里填写一些css
                    'start_url'                => '@homeUrl/payment/checkmoney/start',    // 点击按钮后，跳转的url，在这个url里面写支付跳转前的提交信息。
                    'success_redirect_url'     => '@homeUrl/offlinepayment/offlinepayment/success',            // 在支付平台支付成功后，返回的页面
                    'credentials' => true,
					'sap_id'				   => 'BOD'
                ],
                'payment_FPS' => [    // 货到付款类型。
                    'label'                => 'FPS',
                    //'image' => ['images/mastercard.png','common'] ,# 支付页面显示的图片。
                    'supplement'               => '轉數快 (FPS) 號碼: 6866909', // 补充信息
                    'style'                    => '<style></style>',  // 补充css，您可以在这里填写一些css
                    'start_url'                => '@homeUrl/payment/checkmoney/start',    // 点击按钮后，跳转的url，在这个url里面写支付跳转前的提交信息。
                    'success_redirect_url'     => '@homeUrl/offlinepayment/offlinepayment/success',           // 在支付平台支付成功后，返回的页面
                    'credentials' => true,
                ...
                'paypal_standard' => [
                    ...
                    'label'=> 'PayPal Standard Payments',
        ...
        'childService' => [
			...
			'paypal2' => [
				'class' => 'common\\local\\local_services\\payment\\Paypal2',
			],
            'alipay' => [
