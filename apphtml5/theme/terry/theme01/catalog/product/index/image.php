...
?>
	<?php if(is_array($gallerys) && !empty($gallerys)): ?>
		<?php foreach($gallerys as $gallery): ?>
			...
			<div class="swiper-slide"><img alt="" class="lazy width-100" data-src="<?= Yii::$service->product->image->getResize($image,$middle_img_width,false)  ?>" src="<?= Yii::$service->image->getImgUrl('images/lazyload.gif'); ?>" alt="" ></div>	
		<?php endforeach ?>
	<?php endif; ?>
	</div>
