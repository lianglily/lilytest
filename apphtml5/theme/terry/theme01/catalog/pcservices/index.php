...
?>
<style>
.cmdlist-container img{width:60%;height:auto;}.cmdlist-container{height:130px;text-align: center;}
.alone-version-desc ul{list-style: disc;margin: 0;}.desc_table th,.desc_table td{padding:0}
</style>
		...
		<div class="menu_category">
			...
			<div style="width: 90%;margin: auto;">
				...
				<div>
					...
					<table lay-even lay-skin="line row" lay-size="lg" class="desc_table">
						<thead>
							<tr>
							  <th>電腦數量</th>
							  <th>電話支援</th>
