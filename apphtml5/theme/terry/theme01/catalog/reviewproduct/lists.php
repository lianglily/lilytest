	...
	<div class="col-main">
		<div class="std">
			<div class="review_lists">
				<div class="review_list_product" class="width-100">
					<div class="row">
						<div class="col-20">
							<a external href="<?= $url ?>">
						...
						<div class="margin-20">
							<div class="rbc_cold">
								<span>
									...
									<span class="review_star text-bold review_star_<?= round($reviw_rate_star_average) ?>"  itemprop="average"></span>  
							...
							<div class="content-block">
								<div class="row">
									...
									<div class="col-50">
										<a external class="margin-left-10" href="<?= $addReviewUrl ?>" onclick="" class="submitbutton button  button-fill button-danger">
