		...
		<div class="std">
			<div class="review_add">
				<div class="row">
					<div class="col-20">
						<a external href="<?= $url ?>">
							<img alt="<?= $product_name ?>" src="<?= Yii::$service->product->image->getResize($main_img,[150,150],false) ?>">
						</a>
					</div>
					<div class="col-80">
								...
								<div class="item-content">
								  ...
								  <div class="item-inner">
									...
									<div class="lh30_f">
										...
										<span class="review_span_error display_inline" id="review_price_span" ></span>
									</div>
								...
								<div class="item-content">
									...
									<div class="item-inner">
										...
										<div class="input-box login-captcha">
											...
											<img class="login-captcha-img"  alt="点击刷新" title="点击刷新" src="<?= Yii::$service->url->getUrl('site/helper/captcha'); ?>?<?php echo md5(time() . mt_rand(1,10000));?>" align="absbottom" onclick="this.src='<?= Yii::$service->url->getUrl('site/helper/captcha'); ?>?'+Math.random();"></img>
