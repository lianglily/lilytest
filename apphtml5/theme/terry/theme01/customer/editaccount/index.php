...
<div class="list-block customer-login  customer-register">
	<form method="post" id="form-validate" autocomplete="off" action="<?=  $actionUrl ?>">
		...
		<ul>
				...
				<div class="item-content">
					...
					<div class="item-inner">
						<div class="item-input">
							<input type="text" placeholder="<?= Yii::$service->page->translate->__('Email Address');?>"   readonly="true" id="customer_email" name="editForm[email]" value="<?= $email ?>" title="Email"  class="input-text required-entry color-ccc" />
						</div>
					</div>
				</div>
			</li>
				...
				<div class="item-content">
					...
					<div class="item-inner">
						<div class="item-input">
							...
							<div class="validation-advice display_none" id="required_current_firstname" ><?= Yii::$service->page->translate->__('This is a required field.');?></div>
						</div>
					</div>
				</div>
			</li>
				...
				<div class="item-content">
					...
					<div class="item-inner">
						<div class="item-input">
							...
							<div class="validation-advice display_none" id="required_current_lastname" ><?= Yii::$service->page->translate->__('This is a required field.');?></div>
						</div>
					</div>
				</div>
			</li>
			...
			<li class="fieldset_pass display_none" >
				<div class="item-content">
					<div class="item-media">
						<i class="icon icon-form-name"></i>
					</div>
					<div class="item-inner">
						<div class="item-input">
							...
							<div class="validation-advice display_none" id="required_current_password" ><?= Yii::$service->page->translate->__('This is a required field.');?></div>
				...
				<div class="item-content">
					...
					<div class="item-inner">
						<div class="item-input">
							...
							<div class="validation-advice display_none" id="required_new_password" ><?= Yii::$service->page->translate->__('This is a required field.');?></div>	
						</div>
					</div>
				</div>
			</li>
