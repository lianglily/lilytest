						...
						<div class="item-content">
							...
							<div class="item-inner">
								<div class="item-input">
                                    ...
                                    <img class="login-captcha-img" alt="click refresh" title="<?= Yii::$service->page->translate->__('click refresh'); ?>" src="<?= Yii::$service->url->getUrl('site/helper/captcha'); ?>?<?php echo md5(time() . mt_rand(1,10000));?>" align="absbottom" onclick="this.src='<?= Yii::$service->url->getUrl('site/helper/captcha'); ?>?'+Math.random();"></img>
