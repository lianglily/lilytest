							...
							<tr>
								<td>
									<a external href="<?= Yii::$service->url->getUrl($one['url_key'])  ?>">
										<p  class="text-center"><img alt="<?= $one['url_key'] ?>" src="<?= Yii::$service->product->image->getResize($main_img,[80,80],false) ?>"></p>
									</a>
								</td>
								<td>
									...
									<div class="review_description_centen">
										<div class="category_product category_product-position" >
											<?php
												$diConfig = [
													'price' 		=> $one['price'],
								...
								<td>
									<div class="favorite-Operation addressbook addressbook-position" >
