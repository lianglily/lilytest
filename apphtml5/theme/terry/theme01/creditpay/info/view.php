									...
									<table>
										<tbody>
											<tr><td>
											    ...
											    <img class="layui-upload-img img-100-100" id="demo1" alt="credentials_payment" src="<?=  Yii::$service->url->getUrl('checkout/credentialsupload/imageshow',['msg' => $credentials_payment]);?>">
											    <?php }else{ ?>
											    <img class="layui-upload-img" id="demo1" alt="loader">
											    <?php } ?>
									    	</td></tr>  
										</tbody>
									</table>
