...
<div class="main container one-column">
	<div class="col-main">
		<div class="paypal_success">
			...
			<div class="buttons-set display-inline-block" >
			...
			<div class="buttons-set display-inline-block" >
				<button type="button" class="button" title="Continue Shopping" onclick="window.location='<?=  Yii::$service->url->getUrl('creditpay/info/view',['order_id' => $increment_id]);?>'"><span><span><?= Yii::$service->page->translate->__('Upload Credentials'); ?></span></span></button>
			</div>
