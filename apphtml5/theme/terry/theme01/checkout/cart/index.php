							...
							<div class="row">
								<div class="col-33">
									...
									<a external href="<?= $product_one['url'] ?>" title="<?= $product_one['name'] ?>" class="product-image">
										<img alt="<?= $product_one['name'] ?>" src="<?= Yii::$service->product->image->getResize($product_one['image'],[150,150],false) ?>" alt="<?= $product_one['name'] ?>" width="75" height="75">
									</a>
								</div>
								<div class="col-66">
				...
				<div class="cart-collaterals">
									...
									<div class="discount-form">
										<div class="input-box">
											<div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
												...
												<input class="color-777" class="input-text" id="coupon_code" name="coupon_code" value="<?= $cart_info['coupon_code']; ?>">
											</div>
										</div>
					...
					<div class="cart_cost">
						<div class="row no-gutter">
							...
							<div class="col-33"><?=  $currency_info['code'];  ?><?= Format::price($cart_info['product_total']); ?></div>
						</div>
                       
						<div class="row no-gutter">
							<div class="col-66"><?= Yii::$service->page->translate->__('Shipping Cost');?>  : </div>
							<div class="col-33"><?=  $currency_info['code'];  ?><?= Format::price($cart_info['shipping_cost']); ?></div>
						</div>
						<div class="row no-gutter">
							<div class="col-66"><?= Yii::$service->page->translate->__('Discount');?>  :</div>
							<div class="col-33">-<?=  $currency_info['code'];  ?><?= Format::price($cart_info['coupon_cost']); ?>%</div>
						</div>
						<div class="row no-gutter">
							<div class="col-66"><?= Yii::$service->page->translate->__('Grand Total');?>  :</div>
							<div class="col-33"><?=  $currency_info['code'];  ?><?= Format::price($cart_info['grand_total']) ?></div>
						</div>
					</div>
							...
							<div class="row no-gutter">
								...
								<div class="col-50">
									<a  external class="express_paypal" href="<?= Yii::$service->url->getUrl('payment/paypal/express/start');    ?>">
										<img alt="pay" src="<?= Yii::$service->image->getImgUrl('/images/pay.png') ?>"  />
									</a>
								</div>
                                <?php endif;  ?>
							</div>
