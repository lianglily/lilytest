...
function thissubmit(thiss){
    ...
    console.log(display_type_select);
    if (display_type_select == 'select' || display_type_select == 'editSelect' || display_type_select=='checkbox' || display_type_select=='radio') {
                ...
                <fieldset id="fieldset_table_qbe">
					...
					<div>
						<p class="edit_p" style="width:100%">
                            ...
                            <div class="edit_p display_itemcs" style="display:<?= ($display_type=='select' || $display_type=='editSelect' || $display_type=='checkbox' ||$display_type=='radio')    ? 'block' : 'none'  ?>">
                                    ...
                                    <script>
                                        $(document).ready(function(){
                                            ...
                                            $("body").on("change",".pageContent .display_type_select",function(){
                                                var val = $(this).val();
                                                if (val != 'select' && val != 'editSelect' && val != 'checkbox' && val != 'radio' ) {
                                                    $(".display_itemcs").hide();
