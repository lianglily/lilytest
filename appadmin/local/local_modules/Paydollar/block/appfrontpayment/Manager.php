...
namespace appadmin\local\local_modules\Paydollar\block\appfrontpayment;
...
class Manager extends AppadminbaseBlockEdit implements AppadminbaseBlockEditInterface
{
    ...
    {
         // 需要配置
        $this->_saveUrl = CUrl::getUrl('config/appfrontpayment/managersave');
    ...
    public function getEditArr()
    {
        ...
        return [
			...
			[
                'label' => Yii::$service->page->translate->__('Paydollar'),
                'name'  => 'paydollar_standard',
                'display' => [
                    'type' => 'select',
                    'data' => [
                        Yii::$app->store->enable => 'Enable',
			...
			[
                'label' => Yii::$service->page->translate->__('Creditpay'),
                'name'  => 'creditpay_standard',
                'display' => [
                    'type' => 'select',
                    'data' => [
                        Yii::$app->store->enable => 'Enable',
            ...
            [
                'label' => Yii::$service->page->translate->__('Bank Entry'),
            ...
            [
                'label' => Yii::$service->page->translate->__('FPS'),
                'name'  => 'payment_FPS',
                'display' => [
                    'type' => 'select',
                    'data' => [
            ...
            [
                'label' => Yii::$service->page->translate->__('Cash Cheque'),
                'name'  => 'cash_cheque',
                'display' => [
                    'type' => 'select',
                    'data' => [
