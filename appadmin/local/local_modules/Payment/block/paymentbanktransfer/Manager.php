...
namespace appadmin\local\local_modules\Payment\block\paymentbanktransfer;
...
class Manager extends AppadminbaseBlockEdit implements AppadminbaseBlockEditInterface
{
    public $_saveUrl;
    // 需要配置
    public $_key = 'payment_banktransfer';
    public $_type;
    protected $_attrArr = [
        'image',
        'banktransfer_receipt',
    ];
    ...
    public function init()
    {
         ...
         // 需要配置
        $this->_saveUrl = CUrl::getUrl('payment/paymentbanktransfer/managersave');
    ...
    public function getEditArr()
    {
        ...
        return [
            ...
            [
                'label'  => Yii::$service->page->translate->__('FPS QR'),
                'name' => 'image',
                'display' => [
                    'type' => 'textarea',
                    'lang' => true,
            ...
            [
                'label'  => Yii::$service->page->translate->__('FPS Receipt'),
                'name' => 'banktransfer_receipt',
                'display' => [
                    'type' => 'select',
                    'data' => [
