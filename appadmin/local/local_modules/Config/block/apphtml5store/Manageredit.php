...
namespace appadmin\local\local_modules\config\block\apphtml5store;
...
class Manageredit extends AppadminbaseBlockEdit implements AppadminbaseBlockEditInterface
{
    ...
    {
        $this->_saveUrl = CUrl::getUrl('config/apphtml5store/managereditsave');
        parent::init();
    }
    ...
    public function getEditArr()
    {
        ...
        return [
            ...
            [
                'label'  => Yii::$service->page->translate->__('PC Enable'),
                'name' => 'mobile_enable',
                'display' => [
                    'type' => 'select',
                    'data' => [
            ...
            [
                'label'  => Yii::$service->page->translate->__('PC Condition'),
            ...
            [
                'label'  => Yii::$service->page->translate->__('PC Redirect Domain'),
            ...
            [
                'label'  => Yii::$service->page->translate->__('PC Https Enable'),
            ...
            [
                'label'  => Yii::$service->page->translate->__('PC Type'),
                'name' => 'mobile_type',
                'display' => [
                    'type' => 'select',
                    'data' => [
                        'appfront'    => Yii::$service->page->translate->__('Appfront'),
