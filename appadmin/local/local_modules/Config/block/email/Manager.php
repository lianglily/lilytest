...
namespace appadmin\local\local_modules\Config\block\email;
...
class Manager extends AppadminbaseBlockEdit implements AppadminbaseBlockEditInterface
{
    ...
    protected $_attrArr = [
		...
		'orderCustomerServiceEnabe',
		'orderCustomerServiceEmailAddress',
    ];
    ...
    public function getEditArr()
    {
        ...
        return [
			...
			[
                'label' => Yii::$service->page->translate->__('Order Customer Service Enable'),
                'name'  => 'orderCustomerServiceEnabe',
                'display' => [
                    'type' => 'select',
                    'data' => [
                        Yii::$app->store->enable => 'Yes',
			...
			[
                'label'  => Yii::$service->page->translate->__('Order Customer Service EmailAddress'),
                'name' => 'orderCustomerServiceEmailAddress',
                'display' => [
                    'type' => 'inputString',
                ],
                'remark' => '下单后，联系客服的邮件地址',
            ],
        ];
    }
