...
namespace appadmin\local\local_modules\Config\block\base;
...
class Manager extends AppadminbaseBlockEdit implements AppadminbaseBlockEditInterface
{
    ...
    public function getEditArr()
    {
        ...
        return [
			...
			[
                'label'  => Yii::$service->page->translate->__('Home Meta'),
                'name' => 'default_meta',
                'display' => [
                    'type' => 'inputString',
                    'lang' => true,
			...
			[
                'label'  => Yii::$service->page->translate->__('Home Contact'),
            ...
            [
                'label'  => Yii::$service->page->translate->__('Companny Title'),
                'name' => 'default_title',
                'display' => [
                    'type' => 'inputString',
                    'lang' => true,
